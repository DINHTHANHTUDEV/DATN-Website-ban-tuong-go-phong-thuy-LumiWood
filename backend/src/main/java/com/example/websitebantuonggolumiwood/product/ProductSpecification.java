...
public class ProductSpecification {
    public static Specification<ProductsEntity> filterBy(
            List<Integer> categories, Double minPrice, Double maxPrice, String materials, String keyword, String sizeCategory) {
        ...
        return (root, query, cb) -> {
            ...
            if (materials != null && !materials.isEmpty()) {
                predicates.add(cb.equal(root.get("materials"), materials));
            }
